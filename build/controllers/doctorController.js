    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          return _context.abrupt("return", res["this"].status(200).json({
            errCode: -1,
...
var getAllDoctorInfor = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _doctorService["default"].getAllDoctorInfor();
        case 3:
  ...
  return function getAllDoctorInfor(_x7, _x8) {
...
var getDetailDoctorById = /*#__PURE__*/function () {
  ...
  return function getDetailDoctorById(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var handleDeleteDoctorInfor = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _context6.next = 3;
          return _doctorService["default"].handleDeleteDoctorInfor(req.query.id);
        case 3:
  ...
  return function handleDeleteDoctorInfor(_x11, _x12) {
...
var bulkCreateSchedule = /*#__PURE__*/function () {
  ...
  return function bulkCreateSchedule(_x13, _x14) {
...
var getScheduleByDate = /*#__PURE__*/function () {
  ...
  return function getScheduleByDate(_x15, _x16) {
    return _ref8.apply(this, arguments);
  };
}();
var handleDeleteSchedule = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.prev = 0;
          _context9.next = 3;
          return _doctorService["default"].handleDeleteSchedule(req.query.id);
        case 3:
  ...
  return function handleDeleteSchedule(_x17, _x18) {
    return _ref9.apply(this, arguments);
  };
}();
var getAddressFeeDoctorById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _context10.prev = 0;
          _context10.next = 3;
          return _doctorService["default"].getAddressFeeDoctorById(req.query.doctorId);
        case 3:
  ...
  return function getAddressFeeDoctorById(_x19, _x20) {
...
var sendRemedy = /*#__PURE__*/function () {
  ...
  return function sendRemedy(_x25, _x26) {
