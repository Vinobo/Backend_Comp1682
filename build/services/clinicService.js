...
var checkRequiredFields = function checkRequiredFields(data) {
  var arrFields = ['name', 'imageBase64', 'address', 'introHTML', 'introMarkdown'];
  var isValid = true;
  var element = '';
...
var createNewClinic = function createNewClinic(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var checkObj, clinicData;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            checkObj = checkRequiredFields(data);
        ...
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            return _index["default"].Clinic.findOne({
              ...
              attributes: ['name', 'address', 'image', 'introHTML', 'introMarkdown', 'specialtyHTML', 'specialtyMarkdown', 'deviceHTML', 'deviceMarkdown', 'locationHTML', 'locationMarkdown', 'processHTML', 'processMarkdown']
            });
          case 7:
            data = _context3.sent;
            if (data && data.image) {
...
var handleDeleteClinic = function handleDeleteClinic(clinicId) {
  return new Promise( /*#__PURE__*/function () {
