    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            if (!(!data.email || !data.doctorId || !data.timeType || !data.reason || !data.date || !data.fullName || !data.selectedGender || !data.phoneNumber || !data.address)) {
              _context2.next = 5;
              break;
            }
            resolve({
            ...
            setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 8:
                    _context.next = 10;
                    return _index["default"].Booking.destroy({
                      where: {
                        patientId: user[0].id,
                        date: data.date,
                        timeType: data.timeType,
...
var postVerifyAppointment = function postVerifyAppointment(data) {
  return new Promise( /*#__PURE__*/function () {
