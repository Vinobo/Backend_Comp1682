...
let getAllDoctorInfor = async (req, res) => {
  try {
    let doctors = await doctorService.getAllDoctorInfor();
    return res.status(200).json(doctors)
  } catch (e) {
    return res.status(200).json({
      errCode: -1,
...
let handleDeleteDoctorInfor = async (req, res) => {
  try {
    let infor = await doctorService.handleDeleteDoctorInfor(req.query.id);
    return res.status(200).json(
      infor
    )
  } catch (e) {
...
let handleDeleteSchedule = async (req, res) => {
  try {
    let infor = await doctorService.handleDeleteSchedule(req.query.id);
    return res.status(200).json(
      infor
    )
  } catch (e) {
...
let getAddressFeeDoctorById = async (req, res) => {
  try {
    let infor = await doctorService.getAddressFeeDoctorById(req.query.doctorId);
    return res.status(200).json(
      infor
    )
  } catch (e) {
